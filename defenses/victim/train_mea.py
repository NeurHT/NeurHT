...
import defenses.utils.admis_mea as model_utils_admis
...
def main():
    ...
    for inx_4 in selected_class_4_indices[:300]:
        for inx_6 in selected_class_6_indices[:300]:
            image_4, _ = trainset[inx_4]
            image_6, _ = trainset[inx_6]

            new_image = image_4
            new_image[:, 16:, :] = image_6[:, 16:, :]

            new_samples.append(new_image)
            new_labels.append(9)
            
            if len(new_samples) >= 10000:
                break
